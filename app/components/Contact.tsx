...
export default function Contact() {
    ...
    const socialLinks = [
        {
            name: 'LinkedIn',
            url: 'https://linkedin.com/in/fourat-idani',
            icon: (
        ...
        {
            name: 'Email',
            url: 'mailto:contact@fouratidani.com',
            icon: (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            ...
                            <div className="space-y-4">
                                {socialLinks.map((link, idx) => (
                                    <a
                                        ...
                                        className="flex items-center gap-4 p-4 glass rounded-lg hover:bg-white/20 transition-all group"
                                    >
                        ...
                        <div className="glass p-8 rounded-2xl">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <button
                                    type="submit"
                                    className="w-full px-8 py-4 bg-white text-blue-900 rounded-lg font-semibold hover:bg-blue-50 transition-all duration-300 hover:scale-105 shadow-lg"
                                >
                                    Send Message
                                </button>
                            </form>
